namespace FusionTweaker
{
	partial class ServiceDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.balancedProfileControl = new FusionTweaker.CnQProfileControl();
			this.tabPage2 = new System.Windows.Forms.TabPage();
			this.highPerformanceProfileControl = new FusionTweaker.CnQProfileControl();
			this.tabPage3 = new System.Windows.Forms.TabPage();
			this.powerSaverProfileControl = new FusionTweaker.CnQProfileControl();
			this.turboCoresNumericUpDown = new System.Windows.Forms.NumericUpDown();
			...
			((System.ComponentModel.ISupportInitialize)(this.turboCoresNumericUpDown)).BeginInit();
			...
			this.enableCustomCnQCheckBox.Location = new System.Drawing.Point(3, 147);
			...
			this.toolTip1.SetToolTip(this.label3, "Otherwise the Windows CPU driver will interfere with FusionTweaker.\r\nYou can a" +
					"lternatively set the CPU % range in every Windows power scheme to 100%.");
			...
			this.updateButton.Image = global::FusionTweaker.Properties.Resources.refresh;
			...
			this.tabControl1.Location = new System.Drawing.Point(27, 195);
			this.tabControl1.Name = "tabControl1";
			this.tabControl1.SelectedIndex = 0;
			this.tabControl1.Size = new System.Drawing.Size(360, 182);
			...
			this.tabPage1.Name = "tabPageP0";
			this.tabPage1.Padding = new System.Windows.Forms.Padding(3);
			this.tabPage1.Size = new System.Drawing.Size(352, 156);
			...
			this.balancedProfileControl.Profile = FusionTweaker.CnQProfile.Balanced;
			...
			this.tabPage2.Name = "tabPageP1";
			this.tabPage2.Padding = new System.Windows.Forms.Padding(3);
			this.tabPage2.Size = new System.Drawing.Size(352, 156);
			...
			this.highPerformanceProfileControl.Profile = FusionTweaker.CnQProfile.HighPerformance;
			...
			this.tabPage3.Name = "tabPageP2";
			this.tabPage3.Padding = new System.Windows.Forms.Padding(3);
			this.tabPage3.Size = new System.Drawing.Size(352, 156);
			...
			this.powerSaverProfileControl.Profile = FusionTweaker.CnQProfile.PowerSaver;
			this.powerSaverProfileControl.Size = new System.Drawing.Size(293, 150);
			this.powerSaverProfileControl.TabIndex = 0;
			// 
			// turboCoresNumericUpDown
			// 
			this.turboCoresNumericUpDown.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.turboCoresNumericUpDown.AutoSize = true;
			this.turboCoresNumericUpDown.Enabled = false;
			this.turboCoresNumericUpDown.Location = new System.Drawing.Point(149, 3);
			this.turboCoresNumericUpDown.Name = "turboCoresNumericUpDown";
			this.turboCoresNumericUpDown.Size = new System.Drawing.Size(41, 20);
			this.turboCoresNumericUpDown.TabIndex = 1;
			this.toolTip1.SetToolTip(this.turboCoresNumericUpDown, "Maximum number of cores in the Turbo state (P0) at a time.");
			this.turboCoresNumericUpDown.Value = new decimal(new int[] {
            3,
            0,
            0,
            0});
			...
			this.turboCheckBox.Location = new System.Drawing.Point(3, 4);
			this.turboCheckBox.Name = "turboCheckBox";
			this.turboCheckBox.Size = new System.Drawing.Size(140, 17);
			...
			// serviceController1
			// 
			this.serviceController1.ServiceName = "FusionTweaker";
			// 
			...
			this.flowLayoutPanel1.Controls.Add(this.turboCoresNumericUpDown);
			...
			this.Text = "FusionTweaker service configuration";
			...
			((System.ComponentModel.ISupportInitialize)(this.turboCoresNumericUpDown)).EndInit();
		...
		private System.Windows.Forms.NumericUpDown turboCoresNumericUpDown;
	}
}